...
var typeAhead = function typeAhead(search) {
    ...
    searchInput.on('keyup', function (e) {
        ...
        if (e.keyCode === 40 && current) {
            next = current.nextElementSibling || items[0]; //if I press down, move to the next sibling or the 1st one
        } else if (e.keyCode === 40) {
            next = items[0];
        } else if (e.keyCode === 38 && current) {
            next = current.previousElementSibling || items[items.length - 1]; //if I press down, move to the next sibling or the 1st one
