...
const Store = mongoose.model('Store') // get model previously exported in Store.js
...
exports.getTags = async (req, res) => {
	...
	const storesPromise = Store.find( tag ? {tags: tag} : null )
...
exports.searchStore = async (req, res) => {
	...
	/*
	or we can use the built in sort function and add a compare function
	stores.sort((a,b) => {
...
exports.getHearts = async (req, res) => {
	...
	res.render('stores', {title: 'Favorites', stores: stores});
}
